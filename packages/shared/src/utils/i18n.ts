...
const zh: Translations = {
  ...
  // Cloud Sync
  cloudSync: "云同步",
  cloudSyncDesc: "与自建服务器同步配置",
  syncServerUrl: "服务器地址",
  syncAuthCode: "AUTH_CODE",
  manualPull: "拉取配置",
  manualPush: "推送配置",
  autoSync: "自动同步",
  autoSyncDesc: "关闭后使用浏览器默认跨设备同步",
  lastSyncTime: "上次同步",
  syncSuccess: "同步成功",
  syncFailed: "同步失败",
  syncing: "同步中...",
  neverSynced: "从未同步",
  confirmOverwrite: "此操作将覆盖目标数据，是否继续？",
  confirmOverwriteTitle: "确认操作",
  confirm: "确认",
  ...
  // Auth
  loginTitle: "登录",
  loginPlaceholder: "请输入访问码",
  loginButton: "登录",
  loginError: "访问码错误",
  loginServerNotConfigured: "服务端未配置访问码（AUTH_CODE）",
  loginTooManyAttempts: "请求过于频繁，请稍后再试",
  loginTooManyAttemptsRetry: "请求过于频繁，请在 {seconds} 秒后再试",
  logout: "退出登录"
}
