...
import { fileToPngDataUrlIfSvg } from "@neutab/shared/utils/rasterizeSvg"
import { sanitizeInternalUrl, sanitizeName, sanitizeUrl } from "@neutab/shared/utils/validation"
...
const ShortcutModal = ({
    ...
    const handleFileUpload = async (e: React.ChangeEvent<HTMLInputElement>) => {
        ...
        try {
            const base64 = await fileToPngDataUrlIfSvg(file, 256)
            // Very rough DataURL size guard.
            if (base64.length > MAX_ICON_BYTES * 2) {
                setUrlError?.(t.imageTooLarge)
                return
            }
